...
.block-container { padding: 0rem .8rem 5rem .8rem !important; max-width: 100% !important; }
...
.left-col {
    ...
    padding: 16px 12px;
    min-height: 96vh; margin-top:-18px; position:sticky; top:10px;
}
.sec-title {
...
# LAYOUT
# ══════════════════════════════════════════════════════════════════════════════
col_L, col_R = st.columns([1, 4], gap="small")
